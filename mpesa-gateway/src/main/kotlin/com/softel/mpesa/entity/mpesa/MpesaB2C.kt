...
class MpesaB2C (
        ...
        @Column(nullable = true)
        var workingAccountAvailableFunds: Double?,

        @Column(nullable = true)
        var utilityAccountAvailableFunds: Double?,
        ...
        @Column(nullable = true)
        var chargesPaidAccountAvailableFunds: Double?,

        @Column(nullable = true)
        var recipientIsRegisteredCustomer: String?,
